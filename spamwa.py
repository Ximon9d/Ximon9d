for k in range(jumlah):
  ...
  "origin": "https://www.oyohotel.com",
  "sec-fetch-site": "same-site",
  "sec-fetch-mode": "cors",
  "sec-fetch-dest": "empty",
  "referer": "https://www.oyohotel.com/",
  "accept-encoding": "gzip, deflate, br",
  "accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"}
  data = json.dumps({"phone_number":"+62"+nomer,"channel":"WA"})
  pos = requests.post("https://api.oyohotel.com/go-agent/v2/user/register",headers=head,data=data).text
  if "success" in pos:
